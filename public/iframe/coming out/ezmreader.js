...
//---- USER OPTIONS ----//
const TEMPLATE = 2; // Change this value to set the template
/*  
    Available templates:
    ...
    8: 64 pages
        Micro
*/
const BGCOLOR = '#9e6fb9'; // Change this hex value to set the background color. Remember to keep the quotes!
